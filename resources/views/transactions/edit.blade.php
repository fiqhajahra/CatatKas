...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Formulir Edit Transaksi</h2>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-4 py-2 text-sm font-semibold text-green-800 bg-green-100 border border-green-200 rounded-md">
                            Pemasukan
                        </span>
                        @else
                        <span class="inline-flex items-center px-4 py-2 text-sm font-semibold text-red-800 bg-red-100 border border-red-200 rounded-md">
                            Pengeluaran
                        </span>
                        @endif
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="amount_display"
                            ...
                            value="{{ old('amount') ? number_format(old('amount'), 0, ',', '.') : number_format($transaction->amount, 0, ',', '.') }}">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Contoh: Pembayaran tagihan listrik bulan Juli">{{ old('description', $transaction->description) }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="transactions_date" id="transactions_date" value="{{ old('transactions_date', $transaction->transactions_date->format('Y-m-d')) }}"
                        class="block w-full rounded-md border-gray-300 py-2 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm">
