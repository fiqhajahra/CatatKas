        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Mulai perjalanan menuju keuangan yang lebih baik
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" autocomplete="name" required
                                class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('name') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required
                                class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-1 text-sm text-blue-700">
                            <p>Data Anda dienkripsi dan dilindungi dengan standar keamanan tertinggi.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center text-xs text-gray-500">
                <p>&copy; {{ date('Y') }} FinanceApp. Semua hak cipta dilindungi.</p>
            </div>
        </div>
    </div>
